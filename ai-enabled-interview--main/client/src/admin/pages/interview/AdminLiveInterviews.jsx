      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        {[
          ...
          <div
            ...
            className={`p-5 rounded-3xl border bg-gradient-to-br ${m.color} ${m.border} shadow-sm flex flex-col justify-between transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.03] hover:shadow-2xl hover:shadow-indigo-500/10 cursor-pointer group relative overflow-hidden ${activeStatusFilter === m.id ? "ring-2 ring-indigo-500 shadow-lg scale-[1.02]" : ""
              }`}
          >
