    ...
    <header className="fixed top-0 left-72 right-0 h-20 bg-white shadow-md flex items-center justify-between px-8 z-50">
      ...
      <div className="flex items-center gap-6">
        ...
        <button
          ...
          className="px-4 py-2 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 bg-white transition-transform duration-300 ease-in-out hover:bg-purple-600 hover:border-transparent hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 hidden sm:block"
        >
