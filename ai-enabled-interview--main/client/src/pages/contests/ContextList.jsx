    ...
    <MainLayout>
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-10 px-4">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          {/* Hero Header */}
          <div className="bg-white/60 backdrop-blur-xl shadow-2xl shadow-indigo-100/50 rounded-3xl border border-white p-6 md:p-8 relative overflow-hidden">
            {/* Decorative Blurs */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6 text-center md:text-left">
                <div className="w-16 h-16 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-indigo-500/30 transform hover:scale-110 hover:rotate-12 transition-all duration-300">
                  <Trophy size={32} className="animate-pulse" />
                </div>
                <div>
                  <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-indigo-900 mb-2 tracking-tight">
                    Coding Contests
                  </h1>
                  <p className="text-base text-gray-600 max-w-2xl font-medium">
            ...
            {/* Stats Row */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 relative z-10 pt-6 border-t border-indigo-100/50">
              <div className="group bg-white/50 hover:bg-white rounded-xl p-4 flex flex-col items-center justify-center border border-white hover:border-indigo-100 shadow-sm hover:shadow-md transition-all duration-300 cursor-default">
                <div className="w-12 h-12 flex items-center justify-center bg-indigo-50 rounded-full mb-2 group-hover:scale-110 group-hover:bg-indigo-100 transition-all duration-300">
              ...
              <div className="group bg-white/50 hover:bg-white rounded-xl p-4 flex flex-col items-center justify-center border border-white hover:border-green-100 shadow-sm hover:shadow-md transition-all duration-300 cursor-default">
                <div className="w-12 h-12 flex items-center justify-center bg-green-50 rounded-full mb-2 group-hover:scale-110 group-hover:bg-green-100 transition-all duration-300">
